...
"= is the output of an equation while ==is checking if to variable are equal"
...
# Please write your response in complete sentences.
"parameters are variables inside a method while arguments are the reslut of those variables, the call"

# 7. What is the difference between a function definition 
# and a function invocation? # Please write your response in 
# complete sentences.
"function definition is the definition of a function while invocation is the call of the function"

# 8. Why are functions useful in programming? Provide at least two reasons 
# and write your reasons in in complete sentences.
"They are useful because its a quick way to code and it helps the computer know what you're coding"
